...
public class RyhmersArrayFactory implements Ryhmersfactory {

    @Override public DefaultCountingOutRyhmer getStandardRyhmer() {
        return new DefaultCountingOutRyhmer(new IntArrayStack());
    }

    @Override public DefaultCountingOutRyhmer getFalseRyhmer() {
        return new DefaultCountingOutRyhmer(new IntLinkedList());
    }

    @Override public DefaultCountingOutRyhmer getFIFORyhmer() {
        return new FIFORyhmer(new IntArrayStack());
    }

    @Override public DefaultCountingOutRyhmer getHanoiRyhmer() {
